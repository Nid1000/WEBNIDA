...
class UpdateProductoDto {
    ...
    static _OPENAPI_METADATA_FACTORY() {
        return { nombre: { required: false, type: () => String, minLength: 2, maxLength: 200 }, descripcion: { required: false, type: () => String, minLength: 0, maxLength: 2000 }, precio: { required: false, type: () => Number, minimum: 0 }, categoria_id: { required: false, type: () => Number, minimum: 1 }, stock: { required: false, type: () => Number, minimum: 0 }, destacado: { required: false, type: () => Boolean }, imagen_url: { required: false, type: () => String, nullable: true, format: "uri" } };
    }
}
exports.UpdateProductoDto = UpdateProductoDto;
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: 'Pan artesanal' }),
...
__decorate([
    ...
    (0, class_transformer_1.Type)(() => Number),
    __metadata("design:type", Number)
], UpdateProductoDto.prototype, "categoria_id", void 0);
__decorate([
...
], UpdateProductoDto.prototype, "imagen_url", void 0);
