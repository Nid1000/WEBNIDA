module.exports = [
"[project]/src/app/admin/categorias/nueva/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function NuevaCategoriaPage() {
    ...
    const onSubmit = async (e)=>{
        ...
        try {
            ...
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post('/api/categorias/admin', payload);
            const cat = res.data?.categoria || res.data;
            if (cat?.id) router.push(`/admin/categorias/${cat.id}`);
            else router.push('/admin/categorias');
        } catch (e) {
            const errMsg = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].isAxiosError(e) ? e.response?.data?.message || e.message : e instanceof Error ? e.message : 'No se pudo crear la categoría';
            setError(errMsg);
        } finally{
            setLoading(false);
        }
...
//# sourceMappingURL=src_app_admin_categorias_nueva_page_tsx_c489f26e._.js.map