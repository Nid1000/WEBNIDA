...
function AdminReportesPage() {
    ...
    const admin = isAdmin();
    const [modo, setModo] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("diario");
    ...
    const [topProductos, setTopProductos] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    const [topCategorias, setTopCategorias] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    const cargar = async ()=>{
        try {
            var _vRes_data, _pRes_data, _cRes_data;
            setLoading(true);
            setError(null);
            const params = {};
            if (desde) params.desde = desde;
            if (hasta) params.hasta = hasta;
            const ventasReq = modo === "semanal" ? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get("/api/reportes/admin/ventas-semanales", {
                params
            }) : modo === "mensual" ? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get("/api/reportes/admin/ventas-mensuales", {
                params
            }) : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get("/api/reportes/admin/ventas-diarias", {
                params
            });
            const [vRes, pRes, cRes] = await Promise.all([
                ventasReq,
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get("/api/reportes/admin/top-productos", {
                    params: {
                        ...params,
                        limite: 8
                    }
                }),
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get("/api/reportes/admin/top-categorias", {
                    params: {
                        ...params,
                        limite: 8
                    }
            ...
            const vData = Array.isArray((_vRes_data = vRes.data) === null || _vRes_data === void 0 ? void 0 : _vRes_data.data) ? vRes.data.data : [];
            const chartData = vData.map((item)=>{
                if (modo === "semanal") return {
                    label: String(item.semana),
                    total: Number(item.total || 0)
                };
                if (modo === "mensual") return {
                    label: String(item.mes),
                    total: Number(item.total || 0)
                };
                return {
                    label: String(item.fecha),
                    total: Number(item.total || 0)
                };
            });
            setVentas(chartData);
            setTopProductos(Array.isArray((_pRes_data = pRes.data) === null || _pRes_data === void 0 ? void 0 : _pRes_data.data) ? pRes.data.data : []);
            setTopCategorias(Array.isArray((_cRes_data = cRes.data) === null || _cRes_data === void 0 ? void 0 : _cRes_data.data) ? cRes.data.data : []);
        } catch (e) {
            var _this, _e_response;
            const msg = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].isAxiosError(e) ? ((_this = (_e_response = e.response) === null || _e_response === void 0 ? void 0 : _e_response.data) === null || _this === void 0 ? void 0 : _this.message) || e.message : "No se pudieron cargar los reportes";
            setError(msg);
        } finally{
            setLoading(false);
        }
    ...
    const productosBarData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AdminReportesPage.useMemo[productosBarData]": ()=>topProductos.map({
                "AdminReportesPage.useMemo[productosBarData]": (p)=>({
                        name: p.nombre,
                        cantidad: p.cantidad
                    })
            }["AdminReportesPage.useMemo[productosBarData]"])
    }["AdminReportesPage.useMemo[productosBarData]"], [
        topProductos
    ]);
    const categoriasPieData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AdminReportesPage.useMemo[categoriasPieData]": ()=>topCategorias.map({
                "AdminReportesPage.useMemo[categoriasPieData]": (c)=>({
                        name: c.nombre,
                        value: c.cantidad
                    })
            }["AdminReportesPage.useMemo[categoriasPieData]"])
    }["AdminReportesPage.useMemo[categoriasPieData]"], [
        topCategorias
    ]);
    const COLORS = [
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "inline-flex rounded-md border border-slate-300 bg-white text-sm",
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$design$2f$admin$2f$components$2f$Button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["buttonClasses"])({
                                            variant: modo === "diario" ? "primary" : "ghost",
                                            size: "sm"
                                        }),
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$design$2f$admin$2f$components$2f$Button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["buttonClasses"])({
                                            variant: modo === "semanal" ? "primary" : "ghost",
                                            size: "sm"
                                        }),
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$design$2f$admin$2f$components$2f$Button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["buttonClasses"])({
                                            variant: modo === "mensual" ? "primary" : "ghost",
                                            size: "sm"
                                        }),
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("strong", {
                                    ...
                                    children: modo === "semanal" ? "Ventas semanales" : modo === "mensual" ? "Ventas mensuales" : "Ventas diarias"
                                }, void 0, false, {
                                    fileName: "[project]/src/app/admin/reportes/page.tsx",
                                    lineNumber: 130,
                                    columnNumber: 13
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$design$2f$admin$2f$components$2f$Badge$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Badge$3e$__["Badge"], {
                                    variant: "muted",
                                    size: "sm",
                                    children: modo === "semanal" ? "Total por semana" : modo === "mensual" ? "Total por mes" : "Total por día"
                                }, void 0, false, {
                                    fileName: "[project]/src/app/admin/reportes/page.tsx",
                                    lineNumber: 131,
                                    columnNumber: 13
                                ...
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$recharts$2f$es6$2f$chart$2f$LineChart$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LineChart"], {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$recharts$2f$es6$2f$cartesian$2f$YAxis$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["YAxis"], {
                                            ...
                                            tickFormatter: (v)=>formatPEN(Number(v)),
                                            tickLine: false,
                                            axisLine: {
                                                stroke: '#e5e7eb'
                                            }
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("strong", {
                                    className: "text-slate-900",
                                    children: "Top productos y categorías"
                                }, void 0, false, {
                                    fileName: "[project]/src/app/admin/reportes/page.tsx",
                                    lineNumber: 150,
                                    columnNumber: 13
...
_s(AdminReportesPage, "/Jji4iy8Ex6hsFK/v6lK7pYmCoQ=", false, function() {
    return [
...
//# sourceMappingURL=src_4f801977._.js.map