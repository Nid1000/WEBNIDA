...
class _ProcesoPagoPageState extends State<ProcesoPagoPage> {
  ...
  Future<void> _consultarDni() async {
    ...
    setState(() {
      ...
      if (result == null) {
        _dniError = 'No se pudo validar el DNI con el backend';
      } else {
  ...
  Future<void> _pagar() async {
    ...
    if (orderId == null || orderId.trim().isEmpty) {
      _msg('No se pudo crear el pedido en la web');
    ...
    if (!paid) {
      _msg('No se pudo procesar el pago');
      setState(() => _loading = false);
      return;
    }
                  ...
                  const Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: 4),
                        Text(
                          'Crea tu pedido y emite tu comprobante usando la misma informacion de la web.',
                          style: TextStyle(
            ...
            _box(
              child: Column(
                ...
                children: [
                  ...
                  const Text(
                    'Estos datos se envian al mismo backend que usa tu web para crear el pedido.',
                    style: TextStyle(
                      color: AppColors.muted,
                      fontWeight: FontWeight.w600,
                      height: 1.3,
            ...
            _box(
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 6),
                  const Text(
                    'Se emitira con los datos que lee tu backend web.',
                    style: TextStyle(
                      color: AppColors.muted,
                      fontWeight: FontWeight.w600,
                    ),
                  ...
                  const SizedBox(height: 6),
                  const Text(
                    'La validacion de DNI funciona solo para usuarios autenticados con tu mismo backend web.',
                    style: TextStyle(
                      color: AppColors.muted,
                      fontWeight: FontWeight.w600,
                      fontSize: 12,
