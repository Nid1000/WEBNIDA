...
class _PerfilPageState extends State<PerfilPage> {
  ...
  Future<void> _openBackendDialog() async {
    ...
    _show('Dirección del backend actualizada.');
  ...
  Future<void> _openEditDialog(AppUser user) async {
    ...
    _show('Perfil actualizado. Los cambios ya se reflejan en web y móvil.');
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    ElevatedButton.icon(
                      ...
                      label: const Text('Cambiar IP del backend'),
                    ),
                  ],
                ),
              ),
...
class _BackendConfigDialogState extends State<_BackendConfigDialog> {
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      title: const Text('Backend de la app'),
      content: Form(
        key: _formKey,
        child: Column(
          mainAxisSize: MainAxisSize.min,
          ...
          children: [
            ...
            TextFormField(
              ...
              decoration: const InputDecoration(
                labelText: 'IP o URL del backend',
